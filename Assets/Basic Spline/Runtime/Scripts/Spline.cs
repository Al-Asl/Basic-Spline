...
namespace BasicSpline
{
    ...
    public interface ISpline
    {
        ...
        IEnumerable<ControlPoint> IterateControlPoints();
        ...
        void GetClosestDistance(Vector3 point, out int segmentIndex, out float t);
    }
    ...
    public class Spline : ISpline
    {
        ...
        {
            GetClosestDistance(point, out var index, out var t);
        ...
        public IEnumerable<ControlPoint> IterateControlPoints() => points;
        ...
        public IEnumerable<Segment> IterateSegments() => segments.Take(SegmentCount);
        ...
        public void GetClosestDistance(Vector3 point, out int segmentIndex, out float t)
        {
            ...
            {
                var seg = GetSegment(i);
                var pointOnBox = seg.Bounds.Contains(point) ? point : seg.Bounds.ClosestPoint(point);
